...
description: "零基础小白搭建个人主页的流程，总结了通过ai对网站进行个性化的经验，愿能够有所帮助"
tags:
  - 个人主页
  - AI
language: '中文'
...
- AI使用技能，小白最好用能够自动帮你修改代码的AI，下述是我最近用的非常多的：
  ...
  - Claude Code。非常有用，但需要翻墙，这里提供两个国内可访问的链接。使用VscodeIDE加上Claude Code的插件非常方便。
    - [any Router](https://anyrouter.top/register?aff=5iOh)，纯公益网站，每天签到可以获得25额度，邀请一个人可有50额度。但最近可能是人逐渐多起来了，使用体验极差，一直报错
    - [New API](https://instcopilot-api.com/register?aff=1Fqv)，收费，注册即有7额度，邀请一个人会有2额度，但好在稳定，使用体验非常好。（其实额度也花得比较慢）
...
我之前一直对着[一位学长的主页](https://www.lyt0112.com/)修改，结果突然发现其有[相应的模板](https://github.com/cworld1/astro-theme-pure)，看着我改了那么久的学术主页，再看看这个精美的模板，小登有点破防。在纠结一阵后，最终决定在保留原先主页的同时再搭一个Astro风格的个人博客，成品如下：![image-20250810220750298](images/image-20250810220750298.png)
